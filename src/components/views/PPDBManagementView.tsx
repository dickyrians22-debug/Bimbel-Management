                      ...
                      <td className="py-3.5 px-4">
                        <div className="flex items-center justify-center gap-1.5">
                          ...
                          <button
                            type="button"
                            onClick={() => {
                              if (confirm(`Hapus data calon siswa "${item.studentName}" (${item.registrationNumber})?`)) {
                                onDeleteProspective(item.id);
                              }
                            }}
                  ...
                  <div key={item.id} className="bg-white p-3.5 rounded-2xl border border-slate-200 shadow-xs space-y-2 text-xs">
                    ...
                    <div className="pt-2 border-t border-slate-100 flex items-center justify-between gap-2">
                      <button
                        ...
                        className="px-2 py-1 bg-emerald-50 text-emerald-700 rounded-lg text-[11px] font-bold flex items-center gap-1 cursor-pointer"
                      >
                        <MessageCircle className="w-3.5 h-3.5" />
                        <span>Undang</span>
                      </button>
